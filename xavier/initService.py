...
def update_docker(docker_conf):
    ...
    if not client.containers.list(filters={'name': 'nnvision'+str(docker_conf['docker_version'])}):
        ...
        try:
            client.images.get('roboticia/nnvision_jetson_xavier:'+str(docker_conf['docker_version']))
            logging.warning(f'image {"roboticia/nnvision_jetson_xavier:"+str(docker_conf["docker_version"])} is OK')
            ...
            client.images.pull("roboticia/nnvision_jetson_xavier:"+str(docker_conf['docker_version']))
        # run nnvision
        client.containers.run(
            "roboticia/nnvision_jetson_xavier:"+str(docker_conf['docker_version']),
